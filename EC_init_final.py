...
def model_ini():
    ...
    np.random.seed(seed=1010) # Seet seed so that results can be replicated
    ...
    ASC_G_RND = ASC_G + ASC_G_S * bioDraws('ASC_G_RND', 'NORMAL_MLHS_ANTI') 
    ...
    """
    The utility functions as specified in equations 23-25 in chapter 4.2.1.
    """
    V1_ML = (
            ASC_G_RND + 
            B_P * PG_NORM_TRIP +
